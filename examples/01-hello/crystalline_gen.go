...
import (
	...
	greeting "github.com/Vilsol/crystalline/examples/01-hello/greeting"
)

func init() {
	crystallineNamespace("hello", "greeting").Set("Greet", crystallineWrap(js.FuncOf(crystallineFnGreetingGreet)))
	crystallineNamespace("hello", "greeting").Set("Add", crystallineWrap(js.FuncOf(crystallineFnGreetingAdd)))
...
func crystallineFnGreetingGreet(this js.Value, args []js.Value) (result any) {
	defer crystallineRecover(&result)
...
func crystallineFnGreetingAdd(this js.Value, args []js.Value) (result any) {
	defer crystallineRecover(&result)
